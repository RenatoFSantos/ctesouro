...
**Tests**: Automated tests are required for changed behavior by the constitution.
Include unit, integration, contract, end-to-end, or journey tests at the level
specified in plan.md. If a test is deferred, include the documented risk,
owner, and follow-up task from the plan.
...
- [ ] T004 [P] Configure test runner and coverage/reporting commands
...
- [ ] T011 Define shared performance measurement and UX validation fixtures
...
- [ ] T020 [US1] Add loading, empty, error, success, and permission-limited UX states
- [ ] T021 [US1] Add performance validation for [budget] in [file path]
...
- [ ] T027 [US2] Add UX state handling and performance validation
...
- [ ] T034 [US3] Add UX state handling and performance validation
...
- [ ] TXXX Run formatter, linter, type checks, and full automated test suite
...
- Tests MUST be written and FAIL before implementation unless the plan records a justified exception
